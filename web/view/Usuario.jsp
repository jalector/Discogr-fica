                    ...
                    <div class="container-fluid p-3">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <button class="btn btn-info btn-sm" data-toggle="modal" data-target="#modal-usuario">Detalle</button>
                        ...
                        <div class="row">
                            <div class="col text-right">
                                <button class="btn btn-primary" data-toggle="modal" data-target="#modal-usuario">Registrar nuevo usuario</button>
                            </div>
                        </div>
                    </div>
                </div>
